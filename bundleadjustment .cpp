...
// Count number of 2D measurements of reconstructed 3D points
int BundleAdjustment::count2DMeasurements(const vector<CloudPoint>& pointcloud) {
	int K = 0;
...
void BundleAdjustment::adjustBundle(vector<CloudPoint>& pointcloud, 
								  Mat& cam_matrix,
